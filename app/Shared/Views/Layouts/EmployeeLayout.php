<?php
/*
 * Layout compartido del panel del empleado.
 *
 * Reutiliza el mismo diseño estructural del AdminLayout pero con el
 * sidebar del empleado (menú y color propios).
 */
$pageTitle = $pageTitle ?? 'Empleado';
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <?php require $sharedViewsPath . '/Components/EmployeeSidebar.php'; ?>
