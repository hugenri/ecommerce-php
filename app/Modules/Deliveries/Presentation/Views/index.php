<?php
$pageTitle = 'Admin - Gestión de Entregas';
$pageActive = 'deliveries';
$topbarTitle = 'Gestión de Entregas';
$viewCss = ['/public/css/action-menu.css?v=1'];
$viewJs = ['/public/js/shared/action-menu.js?v=2', '/public/js/deliveries/app.js?v=4'];
        ...
        <div class="row g-3 align-items-center">
            <div class="col-12 col-lg-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="searchInput" placeholder="Folio, cliente, correo o empleado...">
            ...
            <div class="col-6 col-md-3 col-lg-auto ms-lg-auto d-flex gap-2 justify-content-end">
                <button class="btn btn-sm btn-outline-warning align-self-end" type="button" id="btnPending"><i class="bi bi-hourglass-split me-1"></i> Solo pendientes</button>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="filterOffcanvas" aria-labelledby="filterOffcanvasLabel">
    ...
    <div class="offcanvas-body">
        ...
        <div class="mb-3">
            <label class="form-label" for="employeeFilter">Empleado</label>
            <select class="form-select" id="employeeFilter">
                <option value="">Todos</option>
                <?php foreach ($employees as $employee): ?>
                    <option value="<?= (int) $employee['user_id'] ?>"><?= htmlspecialchars($employee['name']) ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="row g-3">
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover mb-0" id="mainTable">
                ...
                <tbody id="tableBody">
                    <tr><td colspan="8" class="text-center text-muted py-4"><i class="bi bi-inbox me-2"></i>Cargando entregas...</td></tr>
                </tbody>
            </table>
        </div>
    </div>
